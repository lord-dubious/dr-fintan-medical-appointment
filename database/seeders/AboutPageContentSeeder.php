...
class AboutPageContentSeeder extends Seeder
{
    ...
    {
        // Enhanced biography based on PDF content with professional copywriting
        PageContent::setContent('about', 'about_intro', 'text', '<p>Dr. Ekochin Fintan represents the distinguished second generation of the renowned EKOCHIN Family of Medical Practitioners. His multicultural upbringing spans Nigeria and Austria, where he developed fluency in Igbo, English, and German languages, providing him with a unique global perspective on healthcare delivery.</p><p>Following his foundational education in Nigeria, Dr. Fintan pursued advanced medical studies in Vienna, Austria, where he mastered Medical Latin and completed a specialized diploma in photographic equipment sales. After the loss of a beloved grandparent, he returned to Nigeria to complete his medical degree, demonstrating his deep commitment to both family values and academic excellence.</p><p>His postgraduate journey began with pioneering work on the Human Stem Cell Transplantation project for Africa at Parklane Specialist Hospital. He then completed his residency training in Internal Medicine at the University of Nigeria Teaching Hospital, with prestigious rotations at Medanta Medicity Hospital and BLK Hospital in New Delhi, India (2011).</p><p>Dr. Fintan further specialized in Neurology and gained invaluable international experience practicing at the NOVANT-managed Forsyth Medical Center in Winston Salem, North Carolina, USA (2015-2016). This exposure to advanced American healthcare systems has enriched his clinical expertise and treatment methodologies.</p><p>As a Fellow of the West African College of Physicians since 2016, Dr. Fintan currently serves as Head of Neurology at ESUT Teaching Hospital Enugu and Senior Lecturer for Neurophysiology at Godfrey Okoye University College of Medicine. His distinguished public service includes serving as Commissioner for Health of Enugu State (2017-2019). He maintains active consultancy roles at Regions Hospital Enugu in affiliation with Regions Neurosciences, Owerri, and serves as a board member of FIT Healthcare Limited.</p><p>Dr. Fintan is happily married to Dr. Cynthia and is a devoted father to three children, balancing his professional excellence with strong family commitments.</p>', 'rich_text');
